...
<p>
  ...
  A Solution describes mechanics, not meaning.<br/>
  Actors exist at the level where meaning matters.<br/>
  Capabilities exist at the level where mechanics matter.<br/>
...
Stability — Persistence of Purpose and Contract over time.
Transition — Intentional semantic change (rare but possible).

## System Dynamics

Resilience — The ability of a system to preserve Actor Purposes despite entropy or failure.
Adaptability — The ability of a system to introduce new Actors or modify Capabilities without semantic disruption.
Coherence — The degree to which Actor Purposes align without contradiction.
Conflict — A condition where fulfilling one Actor’s Purpose prevents another Actor from fulfilling its Purpose.
Evolution — System‑level pattern of Actor creation, modification, and retirement.
